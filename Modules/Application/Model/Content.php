...
namespace wh\CmsConnect\Modules\Application\Model;
...
class Content extends Content_parent
{
    ...
    protected function _assignCMSconnectContent( $sContent )
    {
        ...
        $this->oxcontents__oxcontent->setValue( $sContent, \OxidEsales\Eshop\Core\Field::T_RAW );
    }
    ...
    {
        return Registry::get('oxViewConfig')->getCMSconnect();
    }
}