...
use \wh\CmsConnect\Application\Models;
 ...
 * cmsconnect_cache
 */
class Cache extends \OxidEsales\Eshop\Application\Controller\FrontendController
{
    /**
    ...
    public function clearCmsPageCaches ()
    {
        ...
        $oCmsPagesCache = Models\Cache\CmsPages::get();
