...
use wh\CmsConnect\Application\Utils;
...
class Main extends \OxidEsales\Eshop\Application\Controller\Admin\AdminController
{
    ...
    public function render()
    {
        ...
        foreach ( CMSc_Utils::getMetadataSettings() as $aSetting ) {
            $this->_aViewData[ $aSetting['name'] ] = Utils::getConfigValue($aSetting['name'], $sShopId);
        }
    ...
    public function save()
    {
        ...
        foreach ( CMSc_Utils::getMetadataSettings() as $aSetting ) {
            ...
            Utils::setConfigValue($aSetting['name'], $aParams[ $aSetting['name'] ], $sShopId);
        }
    }
}
