...
namespace wh\CmsConnect\Application\Models\Cache;
 ...
 */
abstract class LocalPages extends Cache
{
    ...
    public static final function get ()
    {
        if ( !static::$_oInstance ) {
            ...
            if ( $sEngine === CMSc_Utils::VALUE_LOCAL_PAGES_CACHE_ENGINE_AUTO ) {
                static::$_oInstance = new Cache\LocalPages\Disabled();
                
//                if ( extension_loaded('memcached') ) {
//                    static::$_oInstance = new Cache\LocalPages\memcached();
//                } else if ( extension_loaded('memcache') ) {
//                    static::$_oInstance = new Cache\LocalPages\memcache();
//                } else {
//                    static::$_oInstance = new Cache\LocalPages\DB();
//                }
            } else {
                switch ( $sEngine ) {
                    ...
                    default:
                        static::$_oInstance = new Cache\LocalPages\OxidFileCache();
                        break;
                }
            }
     ...
     * Override parent.
     *
     * @param string $sLocalPageCacheKey
     * @param CmsPage $oCmsPage
     */
    ...
    protected function _loadOrCreateCurrentLocalPageCache ()
    {
        ...
        // or it was invalid
        if ( !isset($this->_aPageCache[$sCacheKey]) || !$this->_aPageCache[$sCacheKey] ) {
    ...
    protected final function _getCurrentLocalPageData ()
    {
        if ( !$this->_aCurrentLocalPageData ) {
            $sCurrentUrl = Registry::get('oxUtilsUrl')->getCurrentUrl();
