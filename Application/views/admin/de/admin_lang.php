...
$aLang = array(
    ...
    'CMSCONNECT_ADMIN_SETTINGS_sCMScLocalPageCacheEngine'               => 'Cache-Engine für lokale Seiten (global)',
    'CMSCONNECT_ADMIN_SETTINGS_sCMScLocalPageCacheEngine_HELP'          => 'Speichert, auf welcher lokalen Seite welche CMS-Seiten eingebunden sind. <div class="error">Shop-übergreifende Einstellung!</div> <div class="error">Kann zu Fehlern führen, wenn passende Module nicht geladen sind! Vorsicht bei Auswahl von Werten, die nicht "automatisch" sind!</div>',
    ...
    'CMSCONNECT_ADMIN_SETTINGS_sCMScCmsPageCacheEngine'                 => 'Cache-Engine für CMS-Seiten (global)',
    'CMSCONNECT_ADMIN_SETTINGS_sCMScCmsPageCacheEngine_HELP'            => 'Intelligenter Cache für abgerufene CMS-Seiten, damit diese nicht bei jedem lokalen Seitenaufruf neu geladen werden müssen. <div class="error">Shop-übergreifende Einstellung!</div>  <div class="error">Kann zu Fehlern führen, wenn passende Module nicht geladen sind! Vorsicht bei Auswahl von Werten, die nicht "automatisch" sind!</div>',
