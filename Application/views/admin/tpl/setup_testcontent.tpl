...
<form name="myedit" id="myedit" action="[{ $oViewConf->getSelfLink() }]" method="post">
    ...
    <fieldset>
        <legend>[{ oxmultilang ident="CMSCONNECT_ADMIN_TESTCONTENT" }]</legend>
        
        <p>
            [{ oxmultilang ident="CMSCONNECT_ADMIN_TESTCONTENT_INFO" }]
        </p>
        
        <p>
            <textarea name="editval[sCMScTestContent]" style="width: 100%; height: 400px;">[{ if $sCMScTestContent }][{ $sCMScTestContent|htmlentities }][{ else }][{ $oView->getDefaultTestContent()|htmlentities }][{ /if }]</textarea>
        </p>
    </fieldset>
