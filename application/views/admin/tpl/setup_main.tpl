            ...
            <tr>
                ...
                <td class="edittext">
                    <select name="editval[sCMScCmsPageCacheEngine]">
                        <option value="[{ "CMSc_Utils::VALUE_CMS_PAGES_CACHE_ENGINE_AUTO"|constant }]" [{ if $sCMScCmsPageCacheEngine === "CMSc_Utils::VALUE_CMS_PAGES_CACHE_ENGINE_AUTO"|constant }]selected="selected"[{ /if }]>
