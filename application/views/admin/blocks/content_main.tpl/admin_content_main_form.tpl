...
<tr>
    <td class="edittext" width="70">
        [{ oxmultilang ident="CMSXID_ADMIN_CONTENT_PAGE_ID" }]
    </td>
    <td class="edittext">
        ...
        [{ oxinputhelp ident="CMSXID_ADMIN_CONTENT_PAGE_ID_HELP" }]
    </td>
</tr>
<tr>
    <td class="edittext" width="70">
        [{ oxmultilang ident="CMSXID_ADMIN_CONTENT_PAGE" }]
    </td>
    <td class="edittext">
        ...
        [{ oxinputhelp ident="CMSXID_ADMIN_CONTENT_PAGE_HELP" }]
    </td>
</tr>
