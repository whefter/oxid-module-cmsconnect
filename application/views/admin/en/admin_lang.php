...
'CMSCONNECT_ADMIN_SETTINGS_sCMScCurlConnectTimeout'       => 'Connect-Timeout for cURL calls in seconds (default: 1 s)',
'CMSCONNECT_ADMIN_SETTINGS_sCMScCurlExecuteTimeout'       => 'Execute-Timeout for cURL calls in seconds (default: 3 s)',
'CMSCONNECT_ADMIN_SETTINGS_sCMScTtlDefault'               => 'Cache lifetime (default: 3600 s)',
'CMSCONNECT_ADMIN_SETTINGS_sCMScTtlDefaultRnd'            => 'Randomize cache lifetime by',
...
'CMSCONNECT_ADMIN_SETTINGS_sCMScLocalPageCacheEngine'               => 'Cache engine for local pages',
'CMSCONNECT_ADMIN_SETTINGS_sCMScLocalPageCacheEngine_HELP'          => 'Caches which local page includes which CMS page. <div class="error">Can lead to errors if required modules are not loaded. Be careful with values other than "auto".</div>',
